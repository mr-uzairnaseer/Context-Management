...
class NumberParser {
    ...
    */
    public float b(java.lang.String r24, int r25, int r26) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.caverock.androidsvg.NumberParser.b(java.lang.String, int, int):float");
    }
}
