...
class CrossProcessLock {
    ...
    public final FileChannel f73008a;

    /* renamed from: b, reason: collision with root package name */
    public final FileLock f73009b;

    public CrossProcessLock(FileChannel fileChannel, FileLock fileLock) {
        this.f73008a = fileChannel;
        this.f73009b = fileLock;
    }
    ...
    */
    public static com.google.firebase.installations.CrossProcessLock a(android.content.Context r4, java.lang.String r5) throws java.io.IOException {
        /*
            r0 = 0
