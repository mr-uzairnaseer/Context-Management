...
public class EntityArrays {
    ...
    public static final String[][] f162200a;

    /* renamed from: b, reason: collision with root package name */
    public static final String[][] f162201b;

    /* renamed from: c, reason: collision with root package name */
    public static final String[][] f162202c;

    /* renamed from: d, reason: collision with root package name */
    public static final String[][] f162203d;

    /* renamed from: e, reason: collision with root package name */
    public static final String[][] f162204e;

    /* renamed from: f, reason: collision with root package name */
    public static final String[][] f162205f;

    /* renamed from: g, reason: collision with root package name */
    public static final String[][] f162206g;

    /* renamed from: h, reason: collision with root package name */
    public static final String[][] f162207h;

    /* renamed from: i, reason: collision with root package name */
    public static final String[][] f162208i;

    /* renamed from: j, reason: collision with root package name */
    public static final String[][] f162209j;
    ...
    public static String[][] a() {
        return (String[][]) f162206g.clone();
    }

    public static String[][] b() {
        return (String[][]) f162207h.clone();
    }

    public static String[][] c() {
        return (String[][]) f162204e.clone();
    }

    public static String[][] d() {
        return (String[][]) f162205f.clone();
    }

    public static String[][] e() {
        return (String[][]) f162202c.clone();
    }

    public static String[][] f() {
        return (String[][]) f162203d.clone();
    }

    public static String[][] g() {
        return (String[][]) f162200a.clone();
    }

    public static String[][] h() {
        return (String[][]) f162201b.clone();
    }

    public static String[][] i() {
        return (String[][]) f162208i.clone();
    }

    public static String[][] j() {
        return (String[][]) f162209j.clone();
    }

    public static String[][] k(String[][] strArr) {
        String[][] strArr2 = (String[][]) Array.newInstance((Class<?>) String.class, strArr.length, 2);
        for (int i3 = 0; i3 < strArr.length; i3++) {
            strArr2[i3][0] = strArr[i3][1];
            strArr2[i3][1] = strArr[i3][0];
        }
        return strArr2;
    }
}
